...
const buildMessage = (sale: any) => (
  new Discord.MessageEmbed()
	.setColor('#0099ff')
	.setTitle('New ASM Item Sold!')
	.setURL(sale.asset.permalink)
	.setAuthor('Brainy Brian', 'https://files.readme.io/566c72b-opensea-logomark-full-colored.png', 'https://github.com/sbauch/opensea-discord-bot')
...
async function main() {
  ...
  //CONTRACT_ADDRESS is the CA for the ASM Collection
